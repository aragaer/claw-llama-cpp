;; Generated by :claw at 2023-10-16T16:53:09.928162Z
...
(cffi:defcfun ("__claw_llama_batch_free" %llama-cpp::batch-free)
              :void
              (%llama-cpp::batch
...
(cffi:defcfun ("__claw_llama_batch_get_one"
               %llama-cpp::batch-get-one)
              (:pointer (:struct %llama-cpp::batch))
...
(cffi:defcfun ("__claw_llama_batch_init" %llama-cpp::batch-init)
              (:pointer (:struct %llama-cpp::batch))
              (%llama-cpp::%%claw-result-
               (:pointer (:struct %llama-cpp::batch)))
              (%llama-cpp::n-tokens %llama-cpp::int32-t)
...
(cffi:defcfun ("__claw_cE3AE40FE40llama_context_default_params"
...
(cffi:defcfun ("__claw_llama_decode" %llama-cpp::decode)
              :int
              (%llama-cpp::ctx
               (:pointer (:struct %llama-cpp::context)))
              (%llama-cpp::batch
...
(cffi:defcfun ("__claw_llama_get_timings" %llama-cpp::get-timings)
...
(cffi:defcfun ("__claw_llama_load_model_from_file"
...
(cffi:defcfun ("__claw_cE3AE40FE40llama_model_default_params"
...
(cffi:defcfun ("__claw_cE3AE40FE40llama_model_quantize_default_params"
...
(cffi:defcfun ("__claw_llama_new_context_with_model"
